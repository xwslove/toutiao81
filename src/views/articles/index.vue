<template>
  <el-card>
    ...
    <div class="total_title">共找到{{page.total}}条符合条件内容</div>
    <!-- 内容列表 -->
      ...
      <div class="content-item" v-for="(item,index) in list" :key="index">
        ...
        <div class="left">
          ...
          <div class="info">
            ...
            <el-tag style="width:60px" :type="item.status | statusText">标签一</el-tag>
...
export default {
  data () {
    return {
      formData: {
        status: 5, // 默认是全部
        channel_id: null, // 定义频道id当前选择的频道数据

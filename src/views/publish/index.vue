<template>
  <el-card>
    ...
    <el-form ref="myForm" :model="formData" :rules="rules" label-width="80px" class="publish-form">
      ...
      <el-form-item>
        <!-- 父组件给子组件传值 props分面类型 封面图片 -->
        <cover-image @updataImages="updateImages" :images='formData.cover.images'></cover-image>
      </el-form-item>
  ...
  methods: {
    ...
    changeType () {
      ...
      if (this.formData.cover.type === 1) {
        this.formData.cover.images = ['']// 档类型为一个单图时，形成一个地址
